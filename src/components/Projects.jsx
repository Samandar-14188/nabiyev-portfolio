...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      github: 'https://github.com/Samandar-14188/ai-tools-hub', // Agar ochiq kodli bo'lsa
      live: 'https://ai-tools-six-beta.vercel.app',
      color: '#10B981' // To'q yashil (Emerald) rang
    },
    {
      icon: '🌙',
      name: 'Ramazon Rejam',
      desc: 'Ramazon oyi uchun maxsus ishlab chiqilgan shaxsiy rejalashtiruvchi ilova — kunlik namoz, Qur\'on mutolaasi sahifalari, zikr va tarovih ibodatlari monitoringi hamda ma\'naviy progress hisoblagichi.',
      tags: ['React', 'Local Storage', 'Tailwind CSS', 'PWA'],
      github: 'https://github.com/Samandar-14188/ramadan-planner', // O'zgartirishingiz mumkin
      live: 'https://ramazon-planner.vercel.app', // Agar yuklagan bo'lsangiz (yoki o'zgartiring)
      color: '#F59E0B' // Oltin/Sariq (Amber) rang
    }
  ];
  ...
  return (
    <section id="projects" style={{
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        <p style={{ fontSize: '14px', color: '#7F77DD', marginBottom: '0.5rem', textAlign: 'center', letterSpacing: '2px', textTransform: 'uppercase' }}>
          nima qildim
        </p>
        <h2 style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '28px' }}>
          {projects.map((p, i) => (
            ...
            >
              ...
              <div style={{
                ...
                <h3 style={{ fontSize: '22px', fontWeight: '700', color: 'white', marginBottom: '10px' }}>{p.name}</h3>
                <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.6)', lineHeight: '1.6', minHeight: '64px' }}>{p.desc}</p>
              </div>

              {/* Body */}
              <div style={{ padding: '1.5rem 2rem 2.5rem', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '2rem' }}>
                  {p.tags.map((tag, j) => (
                    <span key={j} style={{
                      background: 'rgba(127,119,221,0.06)',
                      color: '#AFA9EC', fontSize: '11px', fontWeight: '500',
                ...
                <div style={{ display: 'flex', gap: '12px' }}>
                  {p.github ? (
                    ...
                    <span style={{
                      ...
                      background: 'rgba(255,255,255,0.01)', cursor: 'not-allowed'
                    }}>
                      🔒 Private
                    </span>
                  )}
                  ...
                  <a href={p.live} target="_blank" rel="noreferrer" style={{
                    flex: 1, padding: '12px', borderRadius: '14px',
                    fontSize: '14px', fontWeight: '600', textAlign: 'center', textDecoration: 'none',
                    color: '#0a0a0f', background: p.color,
          ...
          <div style={{
            ...
            textAlign: 'center', gap: '12px', minHeight: '380px'
          }}>
            <div style={{ fontSize: '42px', opacity: 0.3 }}>🚀</div>
            <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: '16px', fontWeight: '600' }}>Yangi Loyihalar</p>
            <p style={{ color: 'rgba(255,255,255,0.2)', fontSize: '13px' }}>Tez kunda yana qo'shiladi...</p>
          </div>
        </div>
      </div>
    </section>
